...
x_train_st_emb.columns = [f'st_emb_{i}' for i in range(x_train_st_emb.shape[1])]
...
km3, data_3_clusters = make_clusters_and_plot(k = 3, data = x_train_st_emb,  
                                         return_data = True)
# Five clusters
km5, data_5_clusters = make_clusters_and_plot(k = 5, data = x_train_st_emb, 
                                         return_data = True)
# Seven Clusters
km7, data_7_clusters = make_clusters_and_plot(k = 7, data = x_train_st_emb, 
                                         return_data = True)
# Two Clusters
km2, data_2_clusters = make_clusters_and_plot(k = 2, data = x_train_st_emb, 
                                         return_data = True)